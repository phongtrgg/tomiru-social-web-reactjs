...
export enum TweetsActionType {
    ...
    ADD_TWEET_SUCCESS = "tweets/ADD_TWEET_SUCCESS",
    ...
    RESET_STATE = "tweets/RESET_STATE",

    // lấy ra bài viết muốn sửa
    GET_TWEET_REQUEST = "GET_TWEET_REQUEST",
    GET_TWEET_SUCCESS = "GET_TWEET_SUCCESS",
    GET_TWEET_FAILURE = "GET_TWEET_FAILURE",
    // chỉnh sửa bài viết
    EDIT_TWEET_REQUEST = "EDIT_TWEET_REQUEST",
    EDIT_TWEET_SUCCESS = "EDIT_TWEET_SUCCESS",
    EDIT_TWEET_FAILURE = "EDIT_TWEET_FAILURE"
}
...
export interface AddTweetSuccessActionInterface extends Action<TweetsActionType> {
    type: TweetsActionType.ADD_TWEET_SUCCESS;
    // payload: TweetRequest;
}
// edit
export interface EditTweetActionInterface extends Action<TweetsActionType> {
    type: TweetsActionType.EDIT_TWEET;
    payload: EditTweetRequest;
}
/// new
// export interface EditTweetActionInterface {
//     type: TweetsActionType.EDIT_TWEET;
//     payload: TweetRequest;
// }
...
export interface getTweetByIdInterface extends Action<TweetsActionType> {
    type: TweetsActionType.GET_TWEET_REQUEST;
    payload: number;
}

export interface getTweetByIdSuccessInterface extends Action<TweetsActionType> {
    type: TweetsActionType.GET_TWEET_SUCCESS;
    payload: TweetResponse;
}

// sửa bài viết
export interface editTweetRequestInterface extends Action<TweetsActionType> {
    type: TweetsActionType.EDIT_TWEET_REQUEST;
    payload: any;
}

export interface editTweetSuccessInterface extends Action<TweetsActionType> {
    type: TweetsActionType.EDIT_TWEET_SUCCESS;
    payload: TweetResponse;
}

export interface editTweetFailureInterface extends Action<TweetsActionType> {
    type: TweetsActionType.EDIT_TWEET_FAILURE;
    payload: string;
}
export interface resetStateInterface extends Action<TweetsActionType> {
