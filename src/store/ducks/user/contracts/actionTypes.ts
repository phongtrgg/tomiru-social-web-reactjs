...
export enum UserActionsType {
    ...
    SET_HAVE_SENT_EDIT_REQUEST = "SET_HAVE_SENT_EDIT_REQUEST"
}
...
export interface UpdateUserAboutActionInterface extends Action<UserActionsType> {
    type: UserActionsType.UPDATE_ABOUT;
    payload: EditAboutRequest;
}
...
export interface SetHaveSentEditRequestInterface extends Action<UserActionsType> {
