...
import {
    ...
    SetHaveSentEditRequestInterface,
...
export const updatedUserData = (payload: EditUserRequest): UpdateUserDataActionInterface => {
    return {
        type: UserActionsType.UPDATE_USER_DATA,
        payload
    };
};
export const updateUserAbout = (payload: EditAboutRequest): UpdateUserAboutActionInterface => {
    return {
        type: UserActionsType.UPDATE_ABOUT,
        payload
    };
};
...
export const setHaveSentEditRequest = (payload: boolean): SetHaveSentEditRequestInterface => ({
    type: UserActionsType.SET_HAVE_SENT_EDIT_REQUEST,
    payload
});
