...
export enum AddTweetFormTypes {
    ...
    SET_EDIT_IMAGES = "addTweetForm/ SET_EDIT_IMAGES",
    SET_EDIT_MODE = "addTweetForm/SET_EDIT_MODE",
    UPDATE_TWEET = "addTweetForm/UPDATE_TWEET",
...
export interface SetImagesEditActionInterface extends Action<AddTweetFormTypes> {
    type: AddTweetFormTypes.SET_EDIT_IMAGES;
    payload: ImageObj[];
}
