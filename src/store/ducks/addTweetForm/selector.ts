...
//new
export const selectEditImages = (state: RootState) => selectAddTweetFormState(state).imagesEdit;
...
export const selectIsGifsLoading = (state: RootState) =>
    selectAddTweetFormState(state).loadingState === LoadingStatus.LOADING;
export const selectIsGifsLoaded = (state: RootState) =>
    selectAddTweetFormState(state).loadingState === LoadingStatus.LOADED;
