...
export const setUpdatedListTweet = (
...
export const setUpdatedBookmarkedListTweetTweetsState = (
...
export const setFollowToListTweetsState = (
...
export const setBlockedToListTweetsState = (
...
export const outList = (payload: number): OutListActionInterface => ({
    type: ListActionType.OUT_GROUP,
    payload
});

export const resetStatus = (): ResetStatusActionInterface => ({
    type: ListActionType.RESET_STATUS
});

export const outListSuccess = (payload: BaseListResponse): OutListSuccessActionInterface => ({
