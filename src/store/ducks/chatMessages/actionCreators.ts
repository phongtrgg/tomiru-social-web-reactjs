...
import {
    ...
    FetchGroupChatMessagesActionInterface,
    AddChatGroupMessageActionInterface
...
export const fetchGroupChatMessages = (payload: number): FetchGroupChatMessagesActionInterface => ({
    type: ChatMessagesActionsType.FETCH_GROUP_CHAT_MESSAGES,
    payload
});

export const addChatGroupMessage = (payload: ChatMessageRequest): AddChatGroupMessageActionInterface => ({
