...
export enum NotificationsActionsType {
    ...
    SET_NOTIFICATION_AS_READ = "notification/SET_AS_READ",
    MARK_ALL_AS_READ = "notification/MARK_ALL_AS_READ",
    SET_ALL_NOTIFICATIONS_AS_READ = "notification/SET_ALL_NOTIFICATIONS_AS_READ",
    FETCH_DELETE_NOTIFICATION = "notification/FETCH_DELETE_NOTIFICATION",
...
export interface MarkAsReadActionInterface extends Action<NotificationsActionsType> {
    type: NotificationsActionsType.MARK_AS_READ;
    payload: number;
}
export interface setNotificationAsReadInterface extends Action<NotificationsActionsType> {
    type: NotificationsActionsType.SET_NOTIFICATION_AS_READ;
    payload: number;
}
export interface MarkAllNotificationAsReadActionInterface extends Action<NotificationsActionsType> {
    type: NotificationsActionsType.MARK_ALL_AS_READ;
}
export interface SetAllNotificationAsReadActionInterface extends Action<NotificationsActionsType> {
    type: NotificationsActionsType.SET_ALL_NOTIFICATIONS_AS_READ;
}
export interface FetchDeleteNotificationInterface extends Action<NotificationsActionsType> {
    type: NotificationsActionsType.FETCH_DELETE_NOTIFICATION;
    payload: number;
}
export interface DeleteNotificationInterface extends Action<NotificationsActionsType> {
