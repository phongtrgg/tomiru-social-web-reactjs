...
export enum ListsActionType {
    ...
    RESET_STATUS = "lists/RESET_STATUS"
}
...
export interface ResetStatusStateInterface extends Action<ListsActionType> {
    type: ListsActionType.RESET_STATUS;
}
