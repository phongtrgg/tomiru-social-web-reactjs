...
import { ActionModalState, ActionSnackbarState } from "./ducks/actionSnackbar/contracts/state";
...
import { BackgroundState } from "./ducks/changeBackgroundChat/contracts/state";
import { FriendsUserState } from "./ducks/friendUser/contracts/state";
import { FriendRequestsState } from "./ducks/friendRequests/contract/state";
import { FriendsOfAuthUserState } from "./ducks/friendsOfAuthUer/contract/states";
import { PackagesState } from "./ducks/packages/contracts/state";
import { TreeState } from "./ducks/tree/contracts/state";
import { WalletUserState } from "./ducks/wallet/contract/state";
import { WalletHistoryState } from "./ducks/walletHistory/contract/state";
import { AgentsState } from "./ducks/agents/contract/states";
import { TransactionDisplayState } from "./ducks/transactionHistoryDisplayType/states";
import { VaultState } from "./ducks/vault/contract/states";
...
export interface RootState {
    ...
    backgroundChat: BackgroundState;
    friendsUser: FriendsUserState;
    friendRequests: FriendRequestsState;
    friendsOfAuthUser: FriendsOfAuthUserState;
    packages: PackagesState;
    tree: TreeState;
    walletUser: WalletUserState;
    walletHistory: WalletHistoryState;
    agents: AgentsState;
    transactionDisplayType: TransactionDisplayState;
    vaults: VaultState;
}
