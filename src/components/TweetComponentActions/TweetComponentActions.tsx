...
import EditTweetButton from "./EditTweetButton/EditTweetButton";
...
const TweetComponentActions: FC<TweetComponentActionsProps> = memo(
    ({ tweetId, isFullTweet, tweet, isProfile }): ReactElement => {
