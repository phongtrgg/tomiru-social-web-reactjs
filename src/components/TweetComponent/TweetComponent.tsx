...
const TweetComponent: FC<TweetComponentProps> = memo(
    ({ tweet, activeTab, isTweetImageModal, isProfile }): ReactElement => {
                ...
                <div className={classes.tweetWrapper}>
                    ...
                    <div className={classes.tweetContainer}>
                        <div className={classes.header}>
                            ...
                            />
                            <TweetComponentActions tweetId={tweet!.id} tweet={tweet} />
                        </div>
                        <div>
