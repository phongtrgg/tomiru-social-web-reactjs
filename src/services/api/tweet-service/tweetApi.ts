...
export const TweetApi = {
    ...
    async uploadMultiTweetImage(formData: FormData): Promise<AxiosResponse<Image[]>> {
        return await axios.post<Image[]>(UI_V1_TWEETS_UPLOAD, formData, {
            headers: {
                "Content-Type": "multipart/form-data"
            }
    ...
    async editTweet(request: TweetRequest): Promise<AxiosResponse<TweetResponse>> {
        return await axios.put<TweetResponse>(UI_V1_TWEETS_EDIT, request);
    },
