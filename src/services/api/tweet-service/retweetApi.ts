...
export const RetweetApi = {
    ...
    async getRetweetedUsersByTweetId({
        tweetId,
        pageNumber
    }: FetchTweetUsersPayload): Promise<AxiosResponse<UserResponse[]>> {
        return await axios.get<UserResponse[]>(UI_V1_TWEETS_ID_RETWEETED_USERS(tweetId), {
