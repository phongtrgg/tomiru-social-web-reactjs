...
export const ChatMessageApi = {
    ...
    async addMessageGroup(chatMessage: ChatMessageRequest): Promise<AxiosResponse<ChatMessageResponse[]>> {
        return await axios.post<ChatMessageResponse[]>(UI_V1_GROUP_ADD_CHAT, chatMessage);
    }
};
