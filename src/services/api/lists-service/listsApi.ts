...
export const ListsApi = {
    ...
    async outGroup(listId: number): Promise<AxiosResponse<string>> {
        return await axios.delete<string>(UI_V1_LISTS_OUT_ID(listId));
    },
    ...
    ): Promise<AxiosResponse<BaseListResponse>> {
    ...
    async searchListMembersByUsername(
        listId: number,
        username: string
    ): Promise<AxiosResponse<ListsOwnerMemberResponse[]>> {
